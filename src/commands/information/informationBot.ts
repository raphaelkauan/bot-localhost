    ...
    const embed = new EmbedBuilder()
      ...
      .setFields(
        ...
        },
        {
          name: "`/play <link>`",
          value:
            "Reproduz uma música no canal de voz a partir de um link do YouTube. *O título da sua música permanece oculto*. Se já houver uma música tocando, a nova será adicionada à fila.",
        },
        {
          name: "`/pause`",
